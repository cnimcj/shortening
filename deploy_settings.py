...
DATABASES = {
    'default': {
        ...
        'NAME': 'shortening',                      # Or path to database file if using sqlite3.
        'USER': 'shortening',                      # Not used with sqlite3.
...
SECRET_KEY = '7$x0_io&@99)xp)pz+c*%_j6y#bgq+-7-j@3q9&sg+uq#3i-hr'
